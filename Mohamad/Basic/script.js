...
document.querySelector("#results1").innerHTML = `My favorite sandwich is a ${sand.sandwich} which has approximately ${sand.calories} calories, along with it I enjoy eating ${fries2.fries_size} which have about ${fries2.calories} calories`